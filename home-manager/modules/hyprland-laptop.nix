...
home.file.".config/hypr/workspaces-acer.conf".source = ../dotfiles/hypr/workspaces-acer.conf;
home.file.".config/hypr/workspaces-ultrawide.conf".source = ../dotfiles/hypr/workspaces-ultrawide.conf;

home.file.".config/hypr/monitors-acer.conf".text = ''
...
home.file."config/hypr/monitors-ultrawide.conf".text = ''
